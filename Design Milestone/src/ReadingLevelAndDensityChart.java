/**
 * This class creates a chart that displays the z-scores for the average reading level and lexical density by source
 */
...
public class ReadingLevelAndDensityChart implements Charts{
     ...
     * -  the average reading level for each source
     * - the average lexical densities for each source
    ...
    /**
     * converts averages (on a source level) into z-scores (on a corpus level) 
     * for reading level and lexical density for each source.
     * @param Zdata
     * @return Zdata
     */
