...
public class FrequencyCharts extends CommonMethods{
    ...
    public XYChart makeFrequencyChart(){
        ...
        // Create Chart
        org.knowm.xchart.XYChart chart = new XYChartBuilder().width(800).height(600).title("Number of Articles about a person over Time").xAxisTitle("X").yAxisTitle("Y").build();
